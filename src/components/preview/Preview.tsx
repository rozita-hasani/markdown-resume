...
export default function Preview({content = '# Hello World', theme, font, previewContainerRef}: PreviewProps) {
    return (
        <div
        ...
        >
            <ReactMarkdown remarkPlugins={[remarkGfm]}>{content.replace(/\\/g, "")}</ReactMarkdown>
        </div>
    );
};